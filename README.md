...
Unit tests are run by [Jest][] and written with [Jasmine][]. They're located in [src/test/javascript/](demo-core/test/javascript/) and can be run with:
...
You can use Docker to improve your JHipster development experience. A number of docker-compose configuration are available in the [src/main/docker](demo-core/main/docker) folder to launch required third party services.
